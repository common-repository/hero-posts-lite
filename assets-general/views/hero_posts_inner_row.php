<?php
	...
	$class[] = 'hero-posts-row';
	// $class[] = 'hero-posts-row-items-height-' . $array['items_height'];
	
	/* ----------- */
	/* -- Style -- */
	/* ----------- */
	
	$style[] = '--hero-posts-column-gap: ' . $array['column_gap'];	
	...
	// $id = $array['custom_id'] != '' ? $array['custom_id'] : uniqid( 'hero-posts-row-' );
	$id = $array['custom_id'];
