...
class Hero_Posts_Repeater extends Hero_Posts_Base {
	
	static function init() {
		add_shortcode( 'hero_posts_repeater', array( __CLASS__, 'handle_shortcode' ) );
	}
...
Hero_Posts_Repeater::init();


// Map shortcode

function hero_posts_repeater_map() {
	...
	Hero_Posts::$builder->map( 
		...
		array( 
			...
			'description' 					=> esc_html__( 'Repeat content sa many times as you want', 'hero-posts' ), 
			'container' 					=> 'vertical', 
			'icon' 							=> 'bt_bb_icon_hero_posts_repeater', 
			'accept' 						=> array( 'hero_posts_item' => true, 'hero_posts_separator' => true, 'hero_posts_banner' => true, 'hero_posts_html' => true, 'hero_posts_slider_swiper' => true ),
...
add_action( 'wp_loaded', 'hero_posts_repeater_map' );