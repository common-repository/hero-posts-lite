...
class Hero_Posts_Row extends Hero_Posts_Base {
	
	static function init() {
		add_shortcode( 'hero_posts_row', array( __CLASS__, 'handle_shortcode' ) );
	}
...
function hero_posts_row_map() {
	...
	Hero_Posts::$builder->map( 
		'hero_posts_row', 
		array( 
			'name' 							=> esc_html__( 'Row', 'hero-posts' ), 
			'description' 					=> esc_html__( 'Hero posts row', 'hero-posts' ), 
			'container' 					=> 'horizontal', 
			'icon' 							=> 'bt_bb_icon_hero_posts_row', 
			'accept' 						=> array( 'hero_posts_column' => true ), 
			'auto_add' 						=> 'hero_posts_column',
...
add_action( 'wp_loaded', 'hero_posts_row_map' );