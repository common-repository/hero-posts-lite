...
class Hero_Posts_Column extends Hero_Posts_Base {
	
	static function init() {
		add_shortcode( 'hero_posts_column', array( __CLASS__, 'handle_shortcode' ) );
	}
...
Hero_Posts_Column::init();


// Map shortcode

function hero_posts_column_map() {
	...
	$params = array(
		array( 
			...
			'type' 					=> 'dropdown', 
			'default' 				=> 'initial', 
			'heading' 				=> esc_html__( 'Column order', 'hero-posts' ),
			'value' 				=> array(
				esc_html__( 'Initial', 'hero-posts' ) 			=> 'initial',
				esc_html__( '-6', 'hero-posts' ) 				=> '-6',
				esc_html__( '-5', 'hero-posts' ) 				=> '-5',
				esc_html__( '-4', 'hero-posts' ) 				=> '-4',
				esc_html__( '-3', 'hero-posts' ) 				=> '-3',
				esc_html__( '-2', 'hero-posts' ) 				=> '-2',
	...
	Hero_Posts::$builder->map( 
		...
		array( 
			...
			'width_param' 					=> 'width', 
			'container' 					=> 'vertical', 
			'icon' 							=> 'bt_bb_icon_hero_posts_column',
			'accept' 						=> array( 'hero_posts_inner_row' => true, 'hero_posts_item' => true, 'hero_posts_separator' => true, 'hero_posts_banner' => true, 'hero_posts_html' => true, 'hero_posts_slider_swiper' => true, 'hero_posts_repeater' => true ),			
...
add_action( 'wp_loaded', 'hero_posts_column_map' );